...
//        UserDefaults.standard.set(false, forKey: Constant.GlobalConstants.kLoggedIn)
        if  UserDefaults.standard.bool(forKey: Constant.GlobalConstants.kLoggedIn)
        {
            ...
            let navigationController : UINavigationController = storyboard.instantiateViewController(withIdentifier: "landRootNav") as! UINavigationController
            
            //        let rootViewController:UIViewController = storyboard.instantiateViewController(withIdentifier: "LandScreenVC") as UIViewController
...
//        self.navigationSetting()
    ...
    func navigationSetting(){
        ...
        navigationBarAppearace.tintColor = Constant.GlobalConstants.kNavigationBarColor
        navigationBarAppearace.barTintColor = Constant.GlobalConstants.kNavigationTintColor
