...
class TS_MapViewController: UIViewController {
    ...
    let region = (center: CLLocationCoordinate2D(latitude: 25.276987, longitude: 55.296249), delta: 0.1)
...
extension TS_MapViewController: MKMapViewDelegate {
...
extension TS_MapViewController: ClusterManagerDelegate {
...
extension TS_MapViewController {
    enum Selection: Int {
